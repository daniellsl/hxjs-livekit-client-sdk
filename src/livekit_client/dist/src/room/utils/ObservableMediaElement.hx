...
typedef ObservableMediaElement = {
	dynamic function handleResize(entry:Dynamic):Void;
	dynamic function handleVisibilityChanged(entry:js.html.IntersectionObserverEntry):Void;
	/**
	...
	**/
	...
	final msGraphicsTrustStatus : js.html.MSGraphicsTrust;
	final msKeys : js.html.MSMediaKeys;
	/**
	...
	**/
	var src : String;
	var srcObject : Null<ts.AnyOf3<js.html.MediaStream, js.html.MediaSource, js.html.Blob>>;
	...
	**/
	...
	function msSetMediaKeys(mediaKeys:js.html.MSMediaKeys):Void;
	/**
